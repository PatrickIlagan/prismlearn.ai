...
**AMD compute:** every AI response — ingestion, tutoring, quizzes, and flashcards — is
generated by OpenAI's `gpt-oss-120b`, served through [Fireworks AI](https://fireworks.ai),
whose inference platform is [powered by AMD Instinct GPUs](https://fireworks.ai/partners/amd).
No generation happens locally or on any other provider. The same statement is shown,
unauthenticated, on the live site's landing page footer.
